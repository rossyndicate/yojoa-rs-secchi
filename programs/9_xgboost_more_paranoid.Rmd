...
```{r}
# many overfit modesl here.
optimized_booster_jd_5m <- mod_summary_jd_5m$mod[9][[1]]
optimized_booster_jd_3m <- mod_summary_jd_3m$mod[5][[1]]
...
full_stack_simp <- full_stack %>%
  mutate(secchi = predict(optimized_booster_jd_5m, stack_xgb)) %>%
