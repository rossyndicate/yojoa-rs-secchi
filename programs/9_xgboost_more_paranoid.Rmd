...
optimized_booster_3d_3m <- mod_summary_3d_3m$mod[13][[1]]
...
```{r}
# most of best models are overfit, so looking for train/test RMSE that are closer
optimized_booster_5d_3m <- mod_summary_5d_3m$mod[7][[1]]
optimized_booster_5d_5m <- mod_summary_5d_5m$mod[13][[1]]
optimized_booster_5d_71m <- mod_summary_5d_71m$mod[10][[1]]
...
optimized_booster_jd_71m <- mod_summary_jd_71m$mod[2][[1]]
...
ggplot(situ_stack %>%
  ...
  labs(title = 'Yojoa Secchi Historical Record - Site E',
       subtitle = '7/1 day window, 3 day met, moderate data stringency',
