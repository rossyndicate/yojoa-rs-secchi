...
save(mod_summary,best_mod, file = 'data/models/paramsxg_val.RData')
```
...
load('data/models/paramsxg_val.RData')

#Select second mod because train/test rmse are much closer than "best" model
optimized_booster <- mod_summary$mod[2][[1]]
# Apply best mod
preds <- val %>% 
