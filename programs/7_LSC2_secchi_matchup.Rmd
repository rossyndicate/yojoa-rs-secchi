...
While unnecessary for the {xgboost} "gbtree" booster, we will scale the data for comparison with the stepwise regression method. Common methods of normalization include scaling and zscores. While most of the data is both non-normally distributed and/or skewed, we'll use min-max scaling to normalize.
