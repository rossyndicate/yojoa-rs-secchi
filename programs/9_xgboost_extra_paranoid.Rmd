...
save(mod_summary_5d_5m,best_mod_5d_5m, file = 'data/models/paramsxg_val_5d_5m.RData')
...
save(mod_summary_5d_3m,best_mod_5d_3m, file = 'data/models/paramsxg_val_5d_3m.RData')
```
...
save(mod_summary_jd_5m,best_mod_jd_5m, file = 'data/models/paramsxg_val_jd_5m.RData')
```
...
save(mod_summary_jd_3m,best_mod_jd_3m, file = 'data/models/paramsxg_val_jd_3m.RData')
```
...
```{r}
load('data/models/paramsxg_val_5d_5m.RData')
load('data/models/paramsxg_val_5d_3m.RData')
load('data/models/paramsxg_val_jd_5m.RData')
load('data/models/paramsxg_val_jd_3m.RData')
