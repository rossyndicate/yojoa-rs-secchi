...
Let's look at the summary statistics for this model.
...
This generally looks better than before (our adjusted r-squared is
higher that without the met data) AND it's better than the one-day
matchups. Let's play around with the hyper parameters and see what
happens...
