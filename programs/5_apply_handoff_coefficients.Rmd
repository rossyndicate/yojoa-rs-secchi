...
yojoa_rs_sub = yojoa_rs_sub %>% 
  mutate(med_Blue_corr = med_Blue_intercept + med_Blue_B1*med_Blue + med_Blue_B2*med_Blue^2,
         ...
         med_Swir1_corr = med_Swir1_intercept + med_Swir1_B2*med_Swir1 + med_Swir1_B1*med_Swir1^2,
         med_Swir2_corr = med_Swir2_intercept + med_Swir2_B2*med_Swir2 + med_Swir2_B1*med_Swir2^2) %>% 
